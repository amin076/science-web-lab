// src/simulations/subjects/physics/mechanics/gyroscope/HUD.jsx
...
export default function HUD({ hud }) {
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
      ...
      {hud?.note ? (
        <div className="text-white/45 text-sm mb-3">{hud.note}</div>
      ) : null}
...
function Item({ label, unit, value, precision = 4 }) {
  let v = "—";
  if (value === Infinity) v = "∞";
