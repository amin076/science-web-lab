...
// Assuming this constant exists in your project, otherwise replace with 100
...
const ToggleBtn = ({ label, active, onClick, colorClass = "cyan" }) => {
  const colors = {
    cyan: active
      ? "bg-cyan-500/20 text-cyan-200 border-cyan-400/50 shadow-[0_0_15px_rgba(6,182,212,0.2)]"
      : "bg-white/5 text-slate-400 border-white/5 hover:bg-white/10 hover:text-white",
    teal: active
      ? "bg-teal-500/20 text-teal-200 border-teal-400/50 shadow-[0_0_15px_rgba(20,184,166,0.2)]"
      : "bg-white/5 text-slate-400 border-white/5 hover:bg-white/10 hover:text-white",
    purple: active
      ? "bg-violet-500/20 text-violet-200 border-violet-400/50 shadow-[0_0_15px_rgba(139,92,246,0.2)]"
      : "bg-white/5 text-slate-400 border-white/5 hover:bg-white/10 hover:text-white",
    emerald: active
      ? "bg-emerald-500/20 text-emerald-200 border-emerald-400/50 shadow-[0_0_15px_rgba(16,185,129,0.2)]"
      : "bg-white/5 text-slate-400 border-white/5 hover:bg-white/10 hover:text-white",
  };
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 pr-1">
        ...
        <button
          onClick={onReset}
          className="w-full mt-4 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-[10px] font-bold text-white shadow-lg active:scale-[0.98] transition-all backdrop-blur-sm tracking-wider"
        >
          RESET SIMULATION
        </button>
      </div>
