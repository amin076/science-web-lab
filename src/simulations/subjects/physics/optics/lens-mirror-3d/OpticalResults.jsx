    ...
    <div className="mt-6 pt-6 border-t border-white/10 pb-4">
      ...
      <div className="bg-slate-900/40 rounded-xl p-4 border border-white/5 relative overflow-hidden">
        ...
        <div className="text-[10px] text-slate-400 leading-relaxed text-justify">
          {type === "convex-lens" && (
            <>
              Convex Lens (Converging): Forms Real inverted images outside focal
              point, Virtual upright images inside.
            </>
          )}
          {type === "concave-lens" && (
            <>
              Concave Lens (Diverging): Always forms Virtual, Upright, and
              Diminished images.
            </>
          )}
          {type === "concave-mirror" && (
            <>
              Concave Mirror (Converging): Forms Real inverted images outside
              focal point, Virtual upright images inside.
            </>
          )}
          {type === "convex-mirror" && (
            <>
              Convex Mirror (Diverging): Always forms Virtual, Upright, and
              Diminished images.
            </>
          )}
        </div>
