...
| Video shows functioning project and explains WebMCP | PENDING | Script in `SUBMISSION.md`. |
| No unlicensed third-party material in video | PENDING REVIEW | Use Esbiko UI, own narration, and no background music. |
| Final Devpost submission before September 3, 1:00 PM PT | PENDING | Do not edit submission, repo, or live site after deadline during judging. |

## Judging alignment

| Criterion | Submission evidence |
| --- | --- |
| WebMCP Leverage | Six semantic tools, dynamic page lifecycle, validated schemas, structured state, real state mutations, read/write hints, graceful unsupported-browser path. |
| Execution | Existing live educational product plus one polished end-to-end simulation workflow. |
| Potential Impact | Teachers can turn natural-language pedagogical intent into a visible, repeatable scientific experiment while students remain in the loop. |
| Creativity & Ambition | The agent operates and inspects an interactive scientific environment rather than merely explaining science or clicking UI controls. |
